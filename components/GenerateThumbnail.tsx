...
const GenerateThumbnail = ({
  ...
  return (
    <>
      <div className="generate-thumbnail mt-5">
        <Button
      ...
      {isAiThumbnail ? (
        ...
        <div className="image_div" onClick={() => imageRef?.current?.click()}>
          ...
          {!isImageLoading ? (
            ...
            <div className='text-16 flex-center font-medium text-white-1'>Uploading...</div>
          )}
          <div className='flex flex-col items-center gap-1'>
            <h2 className="text-12 font-bold text-orange-1"></h2>
            <h2>Click to upload</h2>
            <p className='text-12 font-normal text-gray-1'>SVF, PNG, or GIF (max. 1080x1080px)</p>
          </div>
        </div>
      )}
      {image && (<div className='flex-center w-full'>
